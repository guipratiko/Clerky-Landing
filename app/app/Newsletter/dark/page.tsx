...
export default function NewsletterDarkPage() {
        ...
        >
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-700 bg-gray-800 px-10 py-2.5 text-sm text-white placeholder:text-gray-500 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
            />
          </div>
        </motion.div>
        ...
        {filteredData.length > 0 ? (
          ...
          >
            {filteredData.map((item, index) => (
              ...
              >
                <Card className="group flex h-full min-h-[300px] flex-col border-gray-700 bg-gray-800 transition-all duration-200 hover:shadow-lg hover:shadow-primary/10">
                  {/* Badge de Tipo */}
                  <div className="relative">
                    {item.imageUrl && (
                  ...
                  <CardHeader className="flex-1">
                    ...
                    <CardTitle className="line-clamp-2 text-xl font-semibold text-white">
                      {item.title}
                    </CardTitle>
                  </CardHeader>

                  <CardContent className="flex-1">
                    <CardDescription className="line-clamp-3 text-sm text-gray-400 md:line-clamp-2">
                      {item.description}
                    </CardDescription>
                      ...
                      <div className="mt-4 flex flex-wrap gap-2">
                        {item.tags.slice(0, 3).map((tag) => (
                          <Badge
                            key={tag}
                            variant="outline"
                            className="border-gray-700 bg-gray-700/50 text-xs text-gray-300"
                          >
